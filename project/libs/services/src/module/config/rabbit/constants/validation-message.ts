export enum EnvValidationMessage {
  ...
  rmqPortRequired = 'RABBITMQ_PORT is required',
  rmqQueueRequired = 'RABBITMQ_QUEUE is required',
  rmqExchangeRequired = 'RABBITMQ_EXCHANGE is required',
  rmqHostRequired = 'RABBITMQ_HOST is required',
}
